...
function PrintDataComponent({ data }) {
    const imagePath = '/src/assets/fillData/ganesha.png'; // Your image path stored separately
    const handlePrint = ()=>{
        console.log("button");
        ...
        <>
            ...
            <div className="a-4-1">
                <div className="frame-1">
                    ...
                    <div className="div4">
                        குறிப்பு: எக்காரணம் கொண்டும் பதிவு கட்டணம் திருப்பி தர இயலாது.
                    </div>
                    ...
                    {/* <div className="rectangle-4" style={image_style}></div> */}
                    <img
                    ...
                    <div className="div7">இனம்: இந்து – வன்னியர்</div>
                    <div className='new'>
                        <table>
                            <tr>
                                <th>Company</th>
...
export default PrintDataComponent
